...
import com.restjersey.nlg.sports.services.SoccerService;
...
@Path("/soccer")
@Api(value="sportsnews", description="Soccer news generation for tri series using NLG")
public class SoccerResource {
	private SoccerService objService = new SoccerService() ;
	...
	@ApiOperation(
			httpMethod = "GET",
			produces = "application/json", value = "Soccer news generation for tri series using NLG"
			)
	@ApiResponses( value= {
